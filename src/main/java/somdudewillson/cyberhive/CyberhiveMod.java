 ...
 *
 *    Keep the ElementsCyberhiveMod object in this class and all calls to this object
...
public class CyberhiveMod {
	...
	public static final SimpleNetworkWrapper PACKET_HANDLER = NetworkRegistry.INSTANCE.newSimpleChannel("cyberhive:a");
	@SidedProxy(clientSide = "somdudewillson.cyberhive.ClientProxyCyberhiveMod", serverSide = "somdudewillson.cyberhive.ServerProxyCyberhiveMod")
	public static IProxyCyberhiveMod proxy;
	@Mod.Instance(MODID)
	public static CyberhiveMod instance;
	public ElementsCyberhiveMod elements = new ElementsCyberhiveMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsCyberhiveMod.GuiHandler());
